...
const U = (id, w = 1200, h = 800) => `https://images.unsplash.com/photo-${id}?w=${w}&h=${h}&fit=crop&q=80`;
const UQ = (q, w = 1200, h = 800) => `https://images.unsplash.com/photo-${q}?w=${w}&h=${h}&fit=crop&q=80`;
...
async function main() {
    ...
    for (const p of pages) {
        await prisma.pageContent.create({
            ...
            data: { tenant_id: tid, page_key: p.page_key, content: p.content },
        });
    }
