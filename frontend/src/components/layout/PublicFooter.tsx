...
export default function PublicFooter() {
  ...
  const instagram = tenant?.instagram_url || 'https://instagram.com/wallcraft.am'
  const facebook = tenant?.facebook_url || 'https://facebook.com/wallcraft.am'
  const tiktok = tenant?.tiktok_url || 'https://tiktok.com/@wallcraft.am'
