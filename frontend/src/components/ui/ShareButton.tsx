...
export function ShareButton() {
  ...
  async function handleShare() {
    ...
    if (navigator.share) {
      try {
        await navigator.share({ title: 'Мой дизайн стены — Wallcraft', text: 'Посмотри какие панели я выбрал!', url })
        return
...
function LinkIcon() {
  return (
    <svg width="13" height="13" viewBox="0 0 13 13" fill="none">
      <path d="M5.5 7.5a3 3 0 004.243 0l1.5-1.5a3 3 0 00-4.243-4.243L6 2.757"
        stroke="currentColor" strokeWidth="1.4" strokeLinecap="round"/>
      <path d="M7.5 5.5a3 3 0 00-4.243 0L1.757 7A3 3 0 006 11.243L7 10.243"
        stroke="currentColor" strokeWidth="1.4" strokeLinecap="round"/>
    </svg>
  )
}
