...
export default function DealersPage() {
  ...
  return (
    <div className="pub-section">
      <PageMeta title="Dealers" description="Find a WallCraft dealer near you." url="/dealers" />
      <FadeIn>
        ...
        <div className="pub-filter-chips">
          <button
            className={`pub-filter-chip${country === '' ? ' active' : ''}`}
            onClick={() => setCountry('')}
          >
          ...
          {countries.map((c) => (
            <button
              key={c}
              className={`pub-filter-chip${country === c ? ' active' : ''}`}
              ...
              <div className="pub-dealer-card">
                ...
                <div>
                  ...
                  <div className="pub-dealer-card__links">
                    {dealer.website && (
                      <a href={dealer.website} target="_blank" rel="noreferrer" className="pub-dealer-card__link">
                        {t('dealers.visit_website')}
                      </a>
                    )}
                    {dealer.map_url && (
                      <a href={dealer.map_url} target="_blank" rel="noreferrer" className="pub-dealer-card__link">
