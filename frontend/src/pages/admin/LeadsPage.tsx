      ...
      style={{
        ...
        border:
          lead.status === 'new'
            ...
            : '1px solid var(--light-surface)',
        boxShadow:
          lead.status === 'new' ? '0 2px 12px rgba(10,132,255,0.08)' : '0 1px 4px rgba(0,0,0,0.04)',
      }}
    >
      <div style={{ display: 'flex', alignItems: 'flex-start', gap: 16 }}>
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 4 }}>
            <span style={{ fontSize: 15, fontWeight: 700, color: 'var(--light-text)' }}>
              {lead.name}
            </span>
            <span
              style={{
          ...
          {lead.comment && (
            <p style={{ fontSize: 12, color: '#9a9890', marginTop: 4, marginBottom: 0 }}>
              💬 {lead.comment}
            </p>
          )}
        </div>
