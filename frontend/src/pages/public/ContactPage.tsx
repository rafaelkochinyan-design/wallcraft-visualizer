...
export default function ContactPage() {
  ...
  return (
    <div className="pub-section">
      ...
      <FadeIn delay={0.1}>
        {/* Mobile-only: show contact buttons above form */}
        <div className="pub-contact-mobile-top">
          {phone && (
            <a href={`tel:${phone}`} className="pub-contact-btn pub-contact-btn--phone">
        ...
        <div className="pub-grid-2" style={{ alignItems: 'start', gap: 64, marginTop: 32 }}>
          ...
          <div className="pub-contact-info pub-contact-info--desktop">
            {phone && (
