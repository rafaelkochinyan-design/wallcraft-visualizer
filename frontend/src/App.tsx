    ...
    <AnimatePresence mode="wait" initial={false}>
      <motion.div key={location.pathname} variants={pageVariants} initial="initial" animate="animate" exit="exit">
        <Routes location={location}>
          ...
          <Route path="/designers" element={<PublicLayout><DesignersPage /></PublicLayout>} />
          <Route path="/designers/:slug" element={<PublicLayout><DesignerDetailPage /></PublicLayout>} />

          <Route path="/dealers" element={<PublicLayout><DealersPage /></PublicLayout>} />
          ...
          <Route path="/installation" element={<PublicLayout><InstallationPage /></PublicLayout>} />
          <Route path="/partners" element={<PublicLayout><PartnersPage /></PublicLayout>} />
          <Route path="/contact" element={<PublicLayout><ContactPage /></PublicLayout>} />

          {/* ── 3D Visualizer (full-screen, no layout) ── */}
